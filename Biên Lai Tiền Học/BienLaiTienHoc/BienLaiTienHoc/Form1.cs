...
namespace BienLaiTienHoc
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'qLThuHocPhiSV1DataSet1.ChiTietBienLai' table. You can move, or remove it, as needed.
            this.chiTietBienLaiTableAdapter.Fill(this.qLThuHocPhiSV1DataSet1.ChiTietBienLai);
            // TODO: This line of code loads data into the 'qLThuHocPhiSV1DataSet.BienLaiTienHoc' table. You can move, or remove it, as needed.
            this.bienLaiTienHocTableAdapter.Fill(this.qLThuHocPhiSV1DataSet.BienLaiTienHoc);
            load();
            Lock();
            Show_cmbsobl("");
        ...
        private void cmbsobl_SelectionChangeCommitted_1(object sender, EventArgs e)
